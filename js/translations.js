	...
	en: {
		...
		projects: {
			...
			zapit: {
				title: 'Zap It',
				description:
					'<a href="https://chromewebstore.google.com/detail/zap-it-web-page-editor/jdcgeigmekmfaakbjaafhhedfgaofmpd?hl=en-US&utm_source=ext_sidebar" target="_blank" class="text-pink-500">Zap It</a> is a Chrome & Firefox extension that allows you to modify the appearance and content of websites. It offers element removal (ads, popups), style customization (colors, fonts, opacity), and local storage of changes.<br /><br />Modifications are saved by domain and persist between sessions. The extension uses CSS selectors, including Tailwind CSS selectors, and provides real-time preview. This extension stores data locally without sending them to external servers.'
			},
			kphotos: {
				title: 'kPhotos',
				description:
